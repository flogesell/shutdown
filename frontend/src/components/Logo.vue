<template>
  <div class="logoIcon">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 226.17 37.95" :id="[ dark ? 'dark' : 'light' ]">
        ...
        <g @click="switchButton" id="switch-btn-logo">
            <path id="switch-btn" class="cls-2" d="M154 15.49 a 7.5 7.5 0 1 1 0 15 H 132.49 a 7.5 7.5 0 0 1 0 -15 H 154 m 0 -5 "/><!-- H 132.49 A 12.5 12.5 0 0 0 120 23 h 0 a 12.5 12.5 0 0 0 12.5 12.5 H 154 A 12.5 12.5 0 0 0 166.52 23 h 0 A 12.5 12.5 0 0 0 154 10.49 Z-->
            ...
            <g id="switch-btn-handle">
            <path class="cls-2" id="switch-handle" d="M132.49 15.49 A 7.5 7.5 0 1 1 125 23 a 7.5 7.5 0 0 1 7.5 -7.5" />
            <path class="cls-2 switch-inside" id="switch-btn-handle-inside" d="M132.49 15.49 A 7.5 7.5 0 1 1 125 23 a 7.5 7.5 0 0 1 7.5 -7.5" />
            </g>
        </g>
    </svg>
  </div>
...
export default {
  ...
  methods: {
    switchButton() {
        var handle = document.getElementsByClassName('#switch-btn-handle');
        console.log(handle);
...
@import '@/assets/styles/_config.scss';
  ...
  svg>#switch-btn-logo>#switch-btn {
    fill: none;
    stroke: $secondary;
    stroke-width: 6.2%;
  }
  svg>#switch-btn-logo>.swith-btn-inside {
      fill: white;
  }
  #light>#switch-btn-logo>#switch-btn-handle>#switch-handle {
      fill: none;
      stroke: $primary;
      stroke-width: 6.2%;
      transition: 0.1s;
  }
  #dark>#switch-btn-logo>#switch-btn-handle>#switch-handle {
      fill: none;
      stroke: white;
      stroke-width: 6.2%;
      transition: 0.1s;
  }
  #light>#switch-btn-logo>#switch-btn-inside {
    fill: white;
  }
  #light>#switch-btn-logo>#switch-btn-handle>#switch-btn-handle-inside {
    fill: white;
  }
  #dark>#switch-btn-logo>#switch-btn-inside {
    fill: $primary;
  }
  #dark>#switch-btn-logo>#switch-btn-handle>#switch-btn-handle-inside {
    fill: $primary;
  }
  #light>#switch-btn-logo:hover,
  #dark>#switch-btn-logo:hover { 
    cursor: pointer;
    & >#switch-btn-handle>#switch-handle {
      stroke-width: 8.2%;
    }
  }
  svg>#switch-btn-handle {
